...
import { ArrowUpRight, Bot, FileText, Gauge, MoveUpRight, Search, Target } from 'lucide-react'
...
export default function Home() {
  return <main className="wayohome">
    <header className="wayonav">
      <Link href="/" className="wayomark"><span>K</span><b>{BRAND.name}</b></Link>
      <div className="wayonav-center"><span>Career operating system</span><i>2026 / BETA</i></div>
      <nav><Link href="/opportunities">Explore</Link><Link href="/growth">Growth</Link><Link href="/community">Community</Link><Link href="/auth">Sign in</Link></nav>
    </header>
    ...
    <section className="wayohero">
      ...
      <div className="hero-copy">
        ...
        <p className="hero-deck">{BRAND.name} connects the evidence in your career to the opportunities in front of you, then helps you act without turning your job search into a numbers game.</p>
